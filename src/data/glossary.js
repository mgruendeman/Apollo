...
export const glossary = [
  ...
  {
    id: 'iss',
    abbr: [{ short: 'ISS', full: 'Inertial Subsystem' }],
    terms: ['ISS'],
    short: 'The guidance platform: gyroscopes and accelerometers on a gimbaled table that knew which way the spacecraft was pointing.',
    long: 'The Inertial Subsystem was the heart of the Command Module\'s guidance: a platform held steady by gyroscopes while the spacecraft turned around it, with accelerometers to measure every push. On Apollo 12 two lightning strikes during launch knocked out power briefly and the platform tumbled ("we\'ve lost the ISS"); the crew realigned it from the stars once they reached orbit.',
  },
  {
    id: 'fdai',
    abbr: [{ short: 'FDAI', full: 'Flight Director Attitude Indicator' }],
    terms: ['eight-ball', 'eight ball', '8-ball', 'FDAI', 'number 1 ball', 'number 2 ball'],
    short: 'The "ball": the cockpit instrument showing the spacecraft\'s attitude, a sphere marked with a grid that turns as the spacecraft does.',
    long: 'The Flight Director Attitude Indicator, nicknamed the "eight ball", showed which way the spacecraft was pointing as a painted ball that rotated inside its case. The Command Module had two; ball 1 took its reference from the guidance platform, so when Apollo 12\'s platform tumbled after the lightning strikes, ball 1 "drifted all over the place" until the platform was realigned.',
  },
  {
    id: 'scs',
    abbr: [{ short: 'SCS', full: 'Stabilization and Control System' }],
    terms: ['stabilization and control system', 'Stabilization and Control System', 'SCS'],
    short: 'The Command Module\'s backup way of controlling attitude, independent of the guidance computer.',
    long: 'The Stabilization and Control System could hold and change the spacecraft\'s attitude with its own gyros and electronics, without the guidance computer. It was the backup if the primary guidance failed, and was used for some routine attitude work to save the computer for other tasks.',
  },
  {
    id: 'bpc',
    abbr: [{ short: 'BPC', full: 'Boost Protective Cover' }],
    terms: ['BPC', 'boost protective cover'],
    short: 'The cover over the Command Module during launch, thrown off with the launch escape tower.',
    long: 'A lightweight cover fitted over the Command Module to protect it from the heat and exhaust of the climb to orbit. It covered most of the windows and was jettisoned with the launch escape tower a few minutes after liftoff. Moisture trapped under it could freeze on the windows, as Pete Conrad found on Apollo 12.',
  },
  {
    id: 'tcp',
    abbr: [{ short: 'TCP', full: 'Thrust Chamber Pressure' }],
    terms: ["TCP's", 'TCPs', 'TCP'],
    short: 'The pressure inside a rocket thruster\'s chamber, the telemetry that showed Mission Control a thruster had really fired.',
    long: 'Each thruster had a sensor on its combustion chamber. A rise in thrust chamber pressure (TCP) proved the thruster had fired, not just that its valves had been sent the command, so Mission Control watched TCPs during the service module thruster "hot fire" test before the flight to the Moon.',
  },
  {
    id: 'pipa-irig',
    abbr: [
      { short: 'PIPA', full: 'Pulsed Integrating Pendulous Accelerometer' },
      { short: 'IRIG', full: 'Inertial Rate Integrating Gyroscope' },
    ],
    terms: ['PIPA BIAS', 'PIPA bias', 'IRIG drift', 'PIPA', 'IRIG'],
    short: 'The guidance platform\'s accelerometers (PIPAs) and gyroscopes (IRIGs), and their small built-in errors.',
    long: 'The guidance platform carried three accelerometers (PIPAs) and three gyroscopes (IRIGs). Every instrument had a small error: an accelerometer read a little acceleration when there was none ("PIPA bias"), and a gyro let the platform slowly wander ("IRIG drift"). Mission Control measured these from telemetry and, when needed, sent up corrections for the computer to apply.',
  },
  {
    id: 'iu-uptel',
    abbr: [{ short: 'IU', full: 'Instrument Unit' }],
    terms: ['IU UPTEL', 'IU uptel', 'Instrument Unit'],
    short: 'The Saturn V\'s own guidance ring, and the switch letting Mission Control send it commands.',
    long: 'The Instrument Unit was a ring of guidance and control equipment on top of the Saturn V\'s third stage. Setting the "IU UPTEL" switch to ACCEPT let Mission Control send commands straight to it, for example to vent propellant or steer the empty third stage away after the spacecraft separated.',
  },
  {
    id: 'refsmmat',
